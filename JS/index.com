...
<div class="card">
  ...
  <div class="grupo">
    <label> INSS (Tabela 2026) </label>
    <input type="text" id="inss" disabled>
  </div>

  <div class="grupo">
    <label>Imposto de Renda (Inseção até 5K)</label>
    <input type="text" id="irrf" disabled>
  </div>
  ...
  <div class="grupo">
    ...
    <input type="text" id="liquido" disabled>
  </div>
